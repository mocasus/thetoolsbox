...
export function ImageToPdf() {
  ...
  return (
    <div className="space-y-4">
      <FileUpload accept="image/png,image/jpeg,image/jpg" multiple onFiles={handleFiles} description="Upload images (PNG, JPG) to convert to PDF" />
      {files.length > 0 && (
        <div className="space-y-3">
          ...
          <Button onClick={convert} disabled={loading} className="w-full">{loading ? "Creating PDF..." : "Convert to PDF"}</Button>
